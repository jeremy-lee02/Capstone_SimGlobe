...
const GamePlay = (props: Props) => {
    const room: Room = JSON.parse(localStorage.getItem("room")|| "{}")
  ...
  return (
    <div className='bg-[#1A1C22] min-h-screen'>
        ...
        <div className='flex mx-5 my-10 gap-10 items-start justify-between'>
            ...
            <AdjustEconomy input_values={team.country.cluster.input_value} room={roomData} onUpdateCountry={handleCountryUpdate} countryName= {team.country.name} userStatus={status} />
        </div>
    </div>
  )
}
