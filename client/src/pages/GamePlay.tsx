...
import Introduction from '../components/gameplay/Introduction'
import RankingModal from '../components/gameplay/RankingModal'
  ...
  return (
    <div className='bg-[#1A1C22] min-h-screen'>
        ...
        <div className='flex gap-10 text-white ml-10 text-lg'>
            <button className='transition hover:scale-105 underline' onClick={() => setShowModal(true)}>Introduction?</button>
            <button className='transition hover:scale-105 underline' onClick={()=> setShowModal2(true)}>View Ranking</button>
